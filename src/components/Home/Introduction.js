        ...
        >
            <div className="flex flex-col items-start justify-start text-left w-full max-w-screen-lg px-5">
                <div className="flex w-full flex-col md:w-full">
                    <h2 className="pb-2 text-7xl font-bold tracking-wide text-blue-300"> {/* Increased font size */}
                        Who Are We
                    </h2>
                    <p className="text-xl md:text-3xl text-black pt-5 leading-relaxed max-w-[800px]"> {/* Increased font size */}
                    ...
                    <p className="text-xl md:text-3xl text-black leading-relaxed max-w-[800px] mt-4"> {/* Increased font size */}
