        ...
        >
            <div className="flex flex-col items-start justify-start text-left w-full max-w-screen-lg px-5">
                <div className="flex w-full flex-col md:w-full">
                    <h2 className="pb-2 text-5xl font tracking-wide text-blue-300">
                        QUALIFIED DRIVER TRAINER
                    </h2>
                    <p className="text-xl md:text-3xl text-black pt-5 leading-relaxed max-w-[800px]">
                    ...
                    <h2 className="pb-2 text-5xl  tracking-wide text-blue-300 mt-8">
                        LOW RISK DRIVING
                    </h2>
                    <p className="text-xl md:text-3xl text-black leading-relaxed max-w-[800px] mt-4">
